...
<template>
  <div class="similar-products">
    ...
    <div class="products-header">
      ...
      <div class="view-collection" @click="handleViewCollection">
        {{ viewText }}
      </div>
    </div>
    ...
    <div class="products-container">
      <Swiper class="products-swiper" :slides-per-view="slidesPerView" :space-between="12" @swiper="handleSwiperInit"
        @slide-change="handleSlideChange">
        <SwiperSlide v-for="product in products" :key="product.id" class="product-slide">
          <ProductCard class="similar-product" :product-data="product" :current-image="getPrimaryImage(product)"
  ...
  <!-- 控制区域（Progress + Arrow） -->
  <CarouselControls :total="products.length" :per-view="slidesPerView" :current-index="currentIndex"
    @update:index="onIndexUpdate" @prev="onPrev" @next="onNext" />
</template>
...
import type { Product, SimilarProductsProps } from '@/types/product'
