...
<template>
  <div class="Category">
    ...
    <div class="product-display">
      ...
      -->
      <ProductCard v-for="item in filteredProducts" :key="item.id" :product-data="item"
        :current-image="getPrimaryImage(item)" @product-click="openProduct" />
    </div>
  </div>
</template>
...
import { fetchCategoryProducts } from '@/services'
import type { CategoryProducts, Product } from '@/types'
